...
export class ProductsDB {
    ...
    static _openDB() {
        return new Promise((resolve, reject) => {
            ...
            openReq.addEventListener("blocked", (e) =>
                reject("Database is already open")
            ); // Throw error
        });
    }
    ...
    insertProduct(product) {
        ...
        return new Promise((resolve, reject) => {
            ...
            addReq.addEventListener("error", (e) =>
                reject("could not add the product")
            );
        });
    }
    ...
    getProduct(key) {
        ...
        return new Promise((resolve, reject) => {
            ...
            getReq.addEventListener("error", (e) =>
                reject(`could not get product ${key}`)
            );
        });
    }
    ...
    updateProduct(product, key = null) {
        ...
        return new Promise((resolve, reject) => {
            ...
            updateReq.addEventListener("error", (e) =>
    ...
    deleteProduct(key) {
        ...
        return new Promise((resolve, reject) => {
            ...
            delReq.addEventListener("error", (e) =>
                reject(`could not remove the product ${key}`)
            );
        });
    }
    ...
    static async deleteDatabase() {
        ...
        return new Promise((resolve, reject) => {
            ...
            deleteReq.addEventListener("error", (e) =>
                reject("Error deleting database")
            ); // error
            deleteReq.addEventListener("blocked", (e) =>
                reject("Database must be closed before deleting")
            ); // error
        });
    }
}
